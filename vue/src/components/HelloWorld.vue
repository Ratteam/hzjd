<template>
    ...
    <header class="indexheader">
      <el-row>
        <el-col :span="24">
          <div >
          <span contenteditable=true>91HZJD</span>
          <span contenteditable=true>网站首页</span>
          <span contenteditable=true>成功案例</span>
          <span contenteditable=true>产品中心</span>
          <span contenteditable=true>新闻中心</span>
          <span contenteditable=true>关于我们</span>
          <span contenteditable=true>咨询热线：13476000321</span>
          </div>
        </el-col>
      </el-row>
    </header>
