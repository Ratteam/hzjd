(function ($) {
    ...
    $(document).on('ready', function () {
        ...
        // Datepicker Init
        // -----------------------------
        $('http://demo.cssmoban.com/cssthemes5/twts_171_classimax/js/.input-group.date').datepicker({
            format: 'dd/mm/yy'
        });
        // -----------------------------
        // Datepicker Init
...
function initialize() {
    ...
    var marker_image ='marker.png'/*tpa=http://demo.cssmoban.com/cssthemes5/twts_171_classimax/js/plugins/google-map/images/marker.png*/;
